...
pub async fn get_folders_trash_items(configuration: &configuration::Configuration, fields: Option<Vec<String>>, limit: Option<i64>, offset: Option<i64>, usemarker: Option<bool>, marker: Option<&str>, direction: Option<&str>, sort: Option<&str>) -> Result<crate::models::Items, Error<GetFoldersTrashItemsError>> {
