...
pub async fn put_users_id_folders0(configuration: &configuration::Configuration, user_id: &str, fields: Option<Vec<String>>, notify: Option<bool>, put_users_id_folders0_request: Option<crate::models::PutUsersIdFolders0Request>) -> Result<crate::models::FolderFull, Error<PutUsersIdFolders0Error>> {
