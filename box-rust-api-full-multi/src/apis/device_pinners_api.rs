...
pub async fn delete_device_pinners_id(configuration: &configuration::Configuration, device_pinner_id: &str) -> Result<(), Error<DeleteDevicePinnersIdError>> {
...
pub async fn get_device_pinners_id(configuration: &configuration::Configuration, device_pinner_id: &str) -> Result<crate::models::DevicePinner, Error<GetDevicePinnersIdError>> {
    let local_var_configuration = configuration;
...
pub async fn get_enterprises_id_device_pinners(configuration: &configuration::Configuration, enterprise_id: &str, marker: Option<&str>, limit: Option<i64>, direction: Option<&str>) -> Result<crate::models::DevicePinners, Error<GetEnterprisesIdDevicePinnersError>> {
    let local_var_configuration = configuration;
