...
pub async fn post_metadata_templates_schema_classifications(configuration: &configuration::Configuration, post_metadata_templates_schema_classifications_request: Option<crate::models::PostMetadataTemplatesSchemaClassificationsRequest>) -> Result<crate::models::ClassificationTemplate, Error<PostMetadataTemplatesSchemaClassificationsError>> {
    let local_var_configuration = configuration;
...
pub async fn put_metadata_templates_enterprise_security_classification6_vm_vochw_uwo_schema_add(configuration: &configuration::Configuration, put_metadata_templates_enterprise_security_classification_6_vm_vochw_uwo_schema_add_request_inner: Option<Vec<crate::models::PutMetadataTemplatesEnterpriseSecurityClassification6VmVochwUwoSchemaAddRequestInner>>) -> Result<crate::models::ClassificationTemplate, Error<PutMetadataTemplatesEnterpriseSecurityClassification6VmVochwUwoSchemaAddError>> {
    let local_var_configuration = configuration;
...
pub async fn put_metadata_templates_enterprise_security_classification6_vm_vochw_uwo_schema_delete(configuration: &configuration::Configuration, put_metadata_templates_enterprise_security_classification_6_vm_vochw_uwo_schema_delete_request_inner: Option<Vec<crate::models::PutMetadataTemplatesEnterpriseSecurityClassification6VmVochwUwoSchemaDeleteRequestInner>>) -> Result<crate::models::ClassificationTemplate, Error<PutMetadataTemplatesEnterpriseSecurityClassification6VmVochwUwoSchemaDeleteError>> {
    let local_var_configuration = configuration;
...
pub async fn put_metadata_templates_enterprise_security_classification6_vm_vochw_uwo_schema_update(configuration: &configuration::Configuration, put_metadata_templates_enterprise_security_classification_6_vm_vochw_uwo_schema_update_request_inner: Option<Vec<crate::models::PutMetadataTemplatesEnterpriseSecurityClassification6VmVochwUwoSchemaUpdateRequestInner>>) -> Result<crate::models::ClassificationTemplate, Error<PutMetadataTemplatesEnterpriseSecurityClassification6VmVochwUwoSchemaUpdateError>> {
    let local_var_configuration = configuration;
