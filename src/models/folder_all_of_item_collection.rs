...
pub struct FolderAllOfItemCollection {
    ...
    pub entries: Option<Vec<crate::models::ItemsAllOfEntriesInner>>,
}

impl FolderAllOfItemCollection {
    pub fn new() -> FolderAllOfItemCollection {
        FolderAllOfItemCollection {
            total_count: None,
            limit: None,
            offset: None,
            order: None,
