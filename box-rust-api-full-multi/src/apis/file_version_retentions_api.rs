...
pub async fn get_file_version_retentions(configuration: &configuration::Configuration, file_id: Option<&str>, file_version_id: Option<&str>, policy_id: Option<&str>, disposition_action: Option<&str>, disposition_before: Option<&str>, disposition_after: Option<&str>, limit: Option<i64>, marker: Option<&str>) -> Result<crate::models::FileVersionRetentions, Error<GetFileVersionRetentionsError>> {
...
pub async fn get_file_version_retentions_id(configuration: &configuration::Configuration, file_version_retention_id: &str) -> Result<crate::models::FileVersionRetention, Error<GetFileVersionRetentionsIdError>> {
    let local_var_configuration = configuration;
