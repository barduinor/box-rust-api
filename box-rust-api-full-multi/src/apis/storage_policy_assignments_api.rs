...
pub async fn delete_storage_policy_assignments_id(configuration: &configuration::Configuration, storage_policy_assignment_id: &str) -> Result<(), Error<DeleteStoragePolicyAssignmentsIdError>> {
...
pub async fn get_storage_policy_assignments(configuration: &configuration::Configuration, resolved_for_type: &str, resolved_for_id: &str, marker: Option<&str>) -> Result<crate::models::StoragePolicyAssignments, Error<GetStoragePolicyAssignmentsError>> {
    let local_var_configuration = configuration;
...
pub async fn get_storage_policy_assignments_id(configuration: &configuration::Configuration, storage_policy_assignment_id: &str) -> Result<crate::models::StoragePolicyAssignment, Error<GetStoragePolicyAssignmentsIdError>> {
    let local_var_configuration = configuration;
...
pub async fn post_storage_policy_assignments(configuration: &configuration::Configuration, post_storage_policy_assignments_request: Option<crate::models::PostStoragePolicyAssignmentsRequest>) -> Result<crate::models::StoragePolicyAssignment, Error<PostStoragePolicyAssignmentsError>> {
    let local_var_configuration = configuration;
...
pub async fn put_storage_policy_assignments_id(configuration: &configuration::Configuration, storage_policy_assignment_id: &str, put_storage_policy_assignments_id_request: Option<crate::models::PutStoragePolicyAssignmentsIdRequest>) -> Result<crate::models::StoragePolicyAssignment, Error<PutStoragePolicyAssignmentsIdError>> {
    let local_var_configuration = configuration;
