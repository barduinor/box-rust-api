...
/// Deletes a webhook.
pub async fn delete_webhooks_id(configuration: &configuration::Configuration, webhook_id: &str) -> Result<(), Error<DeleteWebhooksIdError>> {
...
pub async fn get_webhooks(configuration: &configuration::Configuration, marker: Option<&str>, limit: Option<i64>) -> Result<crate::models::Webhooks, Error<GetWebhooksError>> {
    let local_var_configuration = configuration;
...
pub async fn get_webhooks_id(configuration: &configuration::Configuration, webhook_id: &str) -> Result<crate::models::Webhook, Error<GetWebhooksIdError>> {
    let local_var_configuration = configuration;
...
/// Creates a webhook.
pub async fn post_webhooks(configuration: &configuration::Configuration, post_webhooks_request: Option<crate::models::PostWebhooksRequest>) -> Result<crate::models::Webhook, Error<PostWebhooksError>> {
    let local_var_configuration = configuration;
...
/// Updates a webhook.
pub async fn put_webhooks_id(configuration: &configuration::Configuration, webhook_id: &str, put_webhooks_id_request: Option<crate::models::PutWebhooksIdRequest>) -> Result<crate::models::Webhook, Error<PutWebhooksIdError>> {
    let local_var_configuration = configuration;
