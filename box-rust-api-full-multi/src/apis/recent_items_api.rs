...
pub async fn get_recent_items(configuration: &configuration::Configuration, fields: Option<Vec<String>>, limit: Option<i64>, marker: Option<&str>) -> Result<crate::models::RecentItems, Error<GetRecentItemsError>> {
