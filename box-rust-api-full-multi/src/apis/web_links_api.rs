...
/// Deletes a web link.
pub async fn delete_web_links_id(configuration: &configuration::Configuration, web_link_id: &str) -> Result<(), Error<DeleteWebLinksIdError>> {
...
pub async fn get_web_links_id(configuration: &configuration::Configuration, web_link_id: &str, boxapi: Option<&str>) -> Result<crate::models::WebLink, Error<GetWebLinksIdError>> {
    let local_var_configuration = configuration;
...
pub async fn post_web_links(configuration: &configuration::Configuration, post_web_links_request: Option<crate::models::PostWebLinksRequest>) -> Result<crate::models::WebLink, Error<PostWebLinksError>> {
    let local_var_configuration = configuration;
...
pub async fn put_web_links_id(configuration: &configuration::Configuration, web_link_id: &str, put_web_links_id_request: Option<crate::models::PutWebLinksIdRequest>) -> Result<crate::models::WebLink, Error<PutWebLinksIdError>> {
    let local_var_configuration = configuration;
