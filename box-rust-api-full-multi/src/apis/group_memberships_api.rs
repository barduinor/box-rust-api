...
pub async fn delete_group_memberships_id(configuration: &configuration::Configuration, group_membership_id: &str) -> Result<(), Error<DeleteGroupMembershipsIdError>> {
...
pub async fn get_group_memberships_id(configuration: &configuration::Configuration, group_membership_id: &str, fields: Option<Vec<String>>) -> Result<crate::models::GroupMembership, Error<GetGroupMembershipsIdError>> {
    let local_var_configuration = configuration;
...
pub async fn get_groups_id_memberships(configuration: &configuration::Configuration, group_id: &str, limit: Option<i64>, offset: Option<i64>) -> Result<crate::models::GroupMemberships, Error<GetGroupsIdMembershipsError>> {
    let local_var_configuration = configuration;
...
pub async fn get_users_id_memberships(configuration: &configuration::Configuration, user_id: &str, limit: Option<i64>, offset: Option<i64>) -> Result<crate::models::GroupMemberships, Error<GetUsersIdMembershipsError>> {
    let local_var_configuration = configuration;
...
pub async fn post_group_memberships(configuration: &configuration::Configuration, fields: Option<Vec<String>>, post_group_memberships_request: Option<crate::models::PostGroupMembershipsRequest>) -> Result<crate::models::GroupMembership, Error<PostGroupMembershipsError>> {
    let local_var_configuration = configuration;
...
pub async fn put_group_memberships_id(configuration: &configuration::Configuration, group_membership_id: &str, fields: Option<Vec<String>>, put_group_memberships_id_request: Option<crate::models::PutGroupMembershipsIdRequest>) -> Result<crate::models::GroupMembership, Error<PutGroupMembershipsIdError>> {
    let local_var_configuration = configuration;
