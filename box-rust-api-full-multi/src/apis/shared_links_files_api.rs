...
pub async fn get_files_id_get_shared_link(configuration: &configuration::Configuration, file_id: &str, fields: &str) -> Result<crate::models::FileFull, Error<GetFilesIdGetSharedLinkError>> {
...
pub async fn get_shared_items(configuration: &configuration::Configuration, boxapi: &str, if_none_match: Option<&str>, fields: Option<Vec<String>>) -> Result<crate::models::FileFull, Error<GetSharedItemsError>> {
    let local_var_configuration = configuration;
...
pub async fn put_files_id_add_shared_link(configuration: &configuration::Configuration, file_id: &str, fields: &str, put_files_id_add_shared_link_request: Option<crate::models::PutFilesIdAddSharedLinkRequest>) -> Result<crate::models::FileFull, Error<PutFilesIdAddSharedLinkError>> {
    let local_var_configuration = configuration;
...
pub async fn put_files_id_remove_shared_link(configuration: &configuration::Configuration, file_id: &str, fields: &str, put_files_id_remove_shared_link_request: Option<crate::models::PutFilesIdRemoveSharedLinkRequest>) -> Result<crate::models::FileFull, Error<PutFilesIdRemoveSharedLinkError>> {
    let local_var_configuration = configuration;
...
pub async fn put_files_id_update_shared_link(configuration: &configuration::Configuration, file_id: &str, fields: &str, put_files_id_update_shared_link_request: Option<crate::models::PutFilesIdUpdateSharedLinkRequest>) -> Result<crate::models::FileFull, Error<PutFilesIdUpdateSharedLinkError>> {
    let local_var_configuration = configuration;
