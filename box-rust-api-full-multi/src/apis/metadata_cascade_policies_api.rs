...
pub async fn delete_metadata_cascade_policies_id(configuration: &configuration::Configuration, metadata_cascade_policy_id: &str) -> Result<(), Error<DeleteMetadataCascadePoliciesIdError>> {
...
pub async fn get_metadata_cascade_policies(configuration: &configuration::Configuration, folder_id: &str, owner_enterprise_id: Option<&str>, marker: Option<&str>, offset: Option<i64>) -> Result<crate::models::MetadataCascadePolicies, Error<GetMetadataCascadePoliciesError>> {
    let local_var_configuration = configuration;
...
pub async fn get_metadata_cascade_policies_id(configuration: &configuration::Configuration, metadata_cascade_policy_id: &str) -> Result<crate::models::MetadataCascadePolicy, Error<GetMetadataCascadePoliciesIdError>> {
    let local_var_configuration = configuration;
...
pub async fn post_metadata_cascade_policies(configuration: &configuration::Configuration, post_metadata_cascade_policies_request: Option<crate::models::PostMetadataCascadePoliciesRequest>) -> Result<crate::models::MetadataCascadePolicy, Error<PostMetadataCascadePoliciesError>> {
    let local_var_configuration = configuration;
...
pub async fn post_metadata_cascade_policies_id_apply(configuration: &configuration::Configuration, metadata_cascade_policy_id: &str, post_metadata_cascade_policies_id_apply_request: Option<crate::models::PostMetadataCascadePoliciesIdApplyRequest>) -> Result<(), Error<PostMetadataCascadePoliciesIdApplyError>> {
    let local_var_configuration = configuration;
