...
async fn upload_file(api: &BoxApiClient, folder_id: &str, file_path: &str, box_file_name: &str) {
...
async fn main() {
    ...
    upload_file(&api, "0", "./resources/Rust.png", "Rusty.png").await;

    println!("Uploading file Box.png to root folder (id: 0)");
    upload_file(&api, "0", "./resources/Box.png", "Box.png").await;
