...
pub async fn delete_collaboration_whitelist_exempt_targets_id(configuration: &configuration::Configuration, collaboration_whitelist_exempt_target_id: &str) -> Result<(), Error<DeleteCollaborationWhitelistExemptTargetsIdError>> {
...
pub async fn get_collaboration_whitelist_exempt_targets(configuration: &configuration::Configuration, marker: Option<&str>, limit: Option<i64>) -> Result<crate::models::CollaborationAllowlistExemptTargets, Error<GetCollaborationWhitelistExemptTargetsError>> {
    let local_var_configuration = configuration;
...
pub async fn get_collaboration_whitelist_exempt_targets_id(configuration: &configuration::Configuration, collaboration_whitelist_exempt_target_id: &str) -> Result<crate::models::CollaborationAllowlistExemptTarget, Error<GetCollaborationWhitelistExemptTargetsIdError>> {
    let local_var_configuration = configuration;
...
pub async fn post_collaboration_whitelist_exempt_targets(configuration: &configuration::Configuration, post_collaboration_whitelist_exempt_targets_request: Option<crate::models::PostCollaborationWhitelistExemptTargetsRequest>) -> Result<crate::models::CollaborationAllowlistExemptTarget, Error<PostCollaborationWhitelistExemptTargetsError>> {
    let local_var_configuration = configuration;
