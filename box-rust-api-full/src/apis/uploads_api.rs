...
pub async fn post_files_content(configuration: &configuration::Configuration, params: PostFilesContentParams) -> Result<crate::models::Files, Error<PostFilesContentError>> {
...
pub async fn post_files_id_content(configuration: &configuration::Configuration, params: PostFilesIdContentParams) -> Result<crate::models::Files, Error<PostFilesIdContentError>> {
    let local_var_configuration = configuration;
